...
alias claude-local-q3-8b="$CLAUDE_LOCAL_VARIABLES ANTHROPIC_MODEL=qwen3:8b claude"
...
alias mm_file_update="micromamba env update --file $HOME/Documents/home_conf/micromamba/environment.yml"
